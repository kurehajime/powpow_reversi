...
export default function GameElement() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 12 }}>
      ...
      <div style={{ position: 'relative', width: '100%', maxWidth: 'min(100vw - 24px, 720px)', boxShadow: '0 16px 64px rgba(0,0,0,0.45), 0 0 40px rgba(0,0,0,0.25)' }}>
        <FieldElement
          field={field}
          cellSize={cellSize}
          hints={hints}
      ...
      <div style={{ width: '100%', maxWidth: 'min(100vw - 24px, 720px)', height: topPanelHeight, boxSizing: 'border-box', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: 8 }}>
        {!started ? (
